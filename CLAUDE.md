...
1. **[LANDED PR 4i] Rizin type archive generation + wiring.** Two consolidated archives generated by the SDB walker landed in PR 4h:
   ...
   - **Drift-check workflow**: `.github/workflows/typegen-drift-check.yml` now clones Rizin at a pinned SHA (`RIZIN_REF` env, currently `183a0376c72b08a52863a6f98c832806b9d33b1e`), runs the SDB walker for both archives, and `cmp`-diffs against the checked-in bytes. Bumping the pin requires committing regenerated archives in the same PR.
